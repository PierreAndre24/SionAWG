...
import os, sys
sys.path.append(os.path.abspath('C:\\DATA\\Ratatouille\\Ratatouille32CD12f5'))
...
from stab12_1024_SequenceDict import Generate_SequenceInfo
import numpy as np
...
if __name__ == '__main__':
    ...
    #sion.SendMultiDimensionnalSequenceLight(mdsequence = spinmap, resendstartindex = 480)
    sion.closeCom()
